...
def callback_query(call, save_message_id=None):
    ...
    # Если пользователь выбрал раздел "Планировка здания"
        ...
        bot.edit_message_text(
            chat_id=call.message.chat.id,
            message_id=call.message.message_id,
            text="Вы выбрали 1 этаж",
            parse_mode="HTML",
            reply_markup=floor1_keyboard
        )
        ...
        bot.edit_message_text(
            chat_id=call.message.chat.id,
            message_id=call.message.message_id,
            text="Вы выбрали 2 этаж",
            parse_mode="HTML",
            reply_markup=floor2_keyboard
        )

    elif call.data == "floor1_body1":
        bot.edit_message_text(
            chat_id=call.message.chat.id,
            message_id=call.message.message_id,
            text="Вы выбрали 2 этаж",
            parse_mode="HTML",
            reply_markup=floor1_body1_keyboard
        )
